...
class VAEUtils(object):
    """
    Class to load VAE model and perform operations on it.

    :param exp_file: path to exp file
    :param encoder_file: path to encoder weights file
    :param decoder_file: path to decoder weights file
    ...
    def estimate_estandarization(self):
        """
        Estimate mean and std for standarization.
    ...
    def perturb_z(self, z, noise_norm, constant_norm=False):
        ...
        :param z: Z
        :param noise_norm: noise norm
        :param constant_norm: whether to use constant norm
        :return: perturbed Z
        """
        if noise_norm > 0.0:
    ...
    def smiles_distance_z(self, smiles, z0):
        """
        Calculate distance between Z0 and Z.

        :param smiles: smiles
        :param z0: Z0
        :return: distance between Z0 and Z
        """
    ...
    def prep_mol_df(self, smiles, z):
        """
        Prepare dataframe for molecules.

        :param smiles: smiles
        :param z: Z
        :return: dataframe for molecules
        """
    ...
    def z_to_smiles(self, z, decode_attempts=250, noise_norm=0.0, constant_norm=False, early_stop=None):
        """
        Convert Z to smiles.

        :param z: Z
        :param decode_attempts: decode attempts
        :param noise_norm: noise norm
        :param constant_norm: whether to use constant norm
    ...
    def enc_dec_functions(self, standardized=True):
        ...
        :param standardized: whether to use standardized functions
        ...
        if not self.params["do_tgru"]:
            ...
            def decode(z, standardize=standardized):
                ...
                :param z: Z
                :param standardize: whether to use standardized functions
                :return: decoded Z
                """
    ...
    def predict_prop_Z(self, z, standardized=True):
        """
        Predict property for Z.

        :param z: Z
        :param standardized: whether to use standardized functions
        :return: property prediction for Z
        """
        if standardized:
    ...
    def predict_property_function(self):
        """
        Predict property function.

        :return: property prediction function
        """
    ...
    def ls_sampler_w_prop(self, size=None, batch=2500, return_smiles=False):
        """
        Latent space sampler with property.

        :param size: size
        :param batch: batch
        :param return_smiles: whether to return smiles
        """
    ...
    def smiles_to_hot(self, smiles, canonize_smiles=True, check_smiles=False):
        """
        Convert smiles to hot.

        :param smiles: smiles
        :param canonize_smiles: whether to canonize smiles
        :param check_smiles: whether to check smiles
        :return: hot smiles
        """
